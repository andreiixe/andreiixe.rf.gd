...
<html>
    ...
    <body>
        ...
        <section class='section section-3'>
                                  ...
                                  <tbody>
                                    ...
                                    <td width='60%' style='vertical-align:middle' class='center-mobile'>
                                      ...
                                      <div style='margin-top: 5px;'>
                                        ...
                                        <span style='background-color:rgba(79, 7, 7, 0.5);color:white;font-weight:bold;font-size:0.8em;border: 1px solid rgba(79, 7, 7, 0.5);border-radius: 5px;'>&nbsp;PHP&nbsp;</span>
            ...
            <br>
            <center><footer>
                <p style='font-size: 10px;color: rgb(52, 52, 52);'>Andreiixe website Build 2046 (stable)</p>
            </footer></center>
        </section>"
    ?>
